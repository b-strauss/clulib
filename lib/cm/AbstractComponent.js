...
/**
 * Wait's for some work to be done (e.g. loading third party libraries),
...
/**
 * Get's called after [waitFor] completes and after all child components [onInit] functions have been called.
 */
clulib.cm.AbstractComponent.prototype.onInit = function () {
};

/**
 * Get's the component of the child element that matches the selector.
...
/**
 * Get's all components of the child elements that match the selector.
...
/**
 * Get's called when this component is being disposed with a call to [dispose].
 */
