...
clulib.cm.Component = function () {
  ...
  /**
   * @type {clulib.async.Completer<null>}
   */
  this.onInitCompleter = new clulib.async.Completer();

  /**
   * @type {clulib.async.Completer<null>}
   */
  this.onDisposeCompleter = new clulib.async.Completer();
};
...
clulib.cm.Component.prototype.onInitComplete = function () {
  return this.onInitCompleter.getPromise();
};
...
clulib.cm.Component.prototype.disposeInternal = function () {
  ...
  this.onDisposeCompleter.resolve();
...
clulib.cm.Component.prototype.onDisposeComplete = function () {
  return this.onDisposeCompleter.getPromise();
};