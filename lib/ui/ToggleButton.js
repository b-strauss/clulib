...
clulib.ui.ToggleButton.prototype.onInit = function () {
  ...
  this.listenerKey_ = goog.events.listen(this.getElement(), goog.events.EventType.CLICK, event => {
    this.onClick_(event);
  });
};
 ...
 * @private
 */
clulib.ui.ToggleButton.prototype.onClick_ = function (event) {
  this.toggle();
};
 ...
 * @inheritDoc
 */
clulib.ui.ToggleButton.prototype.onDispose = function () {
  clulib.ui.ToggleButton.base(this, 'onDispose');
